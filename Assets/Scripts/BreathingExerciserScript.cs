...
public class BreathingExercise : MonoBehaviour
{
    ...
    public TMP_Text messageText;      // Tekst g³ówny
    public TMP_Text fearLevelText;    // Tekst paska strachu
    ...
    void Start()
    {
        ...
        fearLevelText.text = "Poziom strachu: " + fearBar; // Ustaw pocz¹tkowy pasek strachu
    }
